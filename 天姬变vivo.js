    ...
    if (jsclick("desc", "注册vivo帐号") || jsclick("text", "注册vivo帐号")) {
      ...
      return false
       ...
       if (className("android.widget.Button").text("同意继续").findOne(200) ){
        ...
        className("android.widget.Button").text("允许").findOne(200).click()
    }
  }
  Tips()
  sleep(1000);
...
var appinfo = {};
appinfo.name = "天姬变vivo";
appinfo.bid = "com.sy4399.tjbfx.vivo";
...
function get_task() {
  ...
  postArr = {};
  postArr["phonename"] = "anzhuo4";
  postArr["imei"] = "hemayun4";
